...
CREATE TABLE IF NOT EXISTS workplace_offices (
 office_id BIGINT NOT NULL AUTO_INCREMENT, company_id BIGINT NOT NULL, name VARCHAR(200) NOT NULL, office_code VARCHAR(50) NOT NULL, address_text VARCHAR(500), city VARCHAR(100), country VARCHAR(100), time_zone VARCHAR(60) NOT NULL DEFAULT 'UTC', status VARCHAR(20) NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE IF NOT EXISTS workplace_buildings (
 building_id BIGINT NOT NULL AUTO_INCREMENT, office_id BIGINT NOT NULL, name VARCHAR(200) NOT NULL, building_code VARCHAR(50) NOT NULL, description VARCHAR(1000), status VARCHAR(20) NOT NULL DEFAULT 'ACTIVE',
 is_deleted TINYINT(1) NOT NULL DEFAULT 0, deleted_at DATETIME, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, created_by BIGINT, updated_by BIGINT, version BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS workplace_floors (
 floor_id BIGINT NOT NULL AUTO_INCREMENT, building_id BIGINT NOT NULL, name VARCHAR(200) NOT NULL, display_order INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS workplace_zones (
 zone_id BIGINT NOT NULL AUTO_INCREMENT, floor_id BIGINT NOT NULL, name VARCHAR(200) NOT NULL, zone_code VARCHAR(50) NOT NULL, display_colour VARCHAR(20) NOT NULL DEFAULT '#64748b', description VARCHAR(1000), status VARCHAR(20) NOT NULL DEFAULT 'ACTIVE',
 is_deleted TINYINT(1) NOT NULL DEFAULT 0, deleted_at DATETIME, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, created_by BIGINT, updated_by BIGINT, version BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS workplace_desks (
 desk_id BIGINT NOT NULL AUTO_INCREMENT, floor_id BIGINT NOT NULL, zone_id BIGINT, desk_code VARCHAR(80) NOT NULL, display_name VARCHAR(200), mode VARCHAR(20) NOT NULL, availability VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS workplace_desk_assignments (
 assignment_id BIGINT NOT NULL AUTO_INCREMENT, desk_id BIGINT NOT NULL, staff_id BIGINT NOT NULL, effective_from DATE NOT NULL, effective_to DATE, is_primary TINYINT(1) NOT NULL DEFAULT 1,
 assignment_reason VARCHAR(1000), assigned_by BIGINT NOT NULL, released_by BIGINT, release_reason VARCHAR(1000),
 is_deleted TINYINT(1) NOT NULL DEFAULT 0, deleted_at DATETIME, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, created_by BIGINT, updated_by BIGINT, version BIGINT NOT NULL DEFAULT 0,
